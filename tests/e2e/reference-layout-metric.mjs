...
const PROJECT_RULES = {
  'desktop-chromium': {
    ...
    minSliceIdentityMargins: [0.001, 0.02, 0.002, 0.005, 0.005],
    minSliceEnergyRatios: [0.65, 0.7, 0.7, 0.7, 0.7],
  },
  'mobile-chromium': {
    bands: [0, 0.08, 0.16, 0.18, 0.46, 1],
    labels: ['hero/search', 'stats', 'category', 'featured-shelf', 'contribution'],
    minBandScores: [0.921, 0.893, 0.878, 0.91, 0.91],
    minBandEnergies: [0.02, 0.04, 0.03, 0.025, 0.03],
    maxLowVarianceRuns: [Infinity, Infinity, Infinity, Infinity, Infinity],
    minIdentityScores: [0.84, 0.8, 0.79, 0.86, 0.86],
    minIdentityMargins: [0.015, -0.01, 0.015, 0.015, 0.015],
    minSliceIdentityScores: [0.9, 0.9, 0.9, 0.9, 0.9],
    minSliceIdentityMargins: [0.005, -0.04, -0.05, 0.005, 0.005],
    minSliceEnergyRatios: [0.7, 0.5, 0, 0.7, 0.7],
  },
};
